...
export const About: React.FC<AboutProps> = ({ onShowToast }) => {
  const workflowSteps = [
    ...
    },
    {
      ...
      desc: "Serving real-time Random Forest predictions through a modern SaaS React & Express stack."
    }
  ];
  ...
  const technologies = [
    ...
    { name: "Express.js", category: "Node API Server", color: "bg-slate-100 text-slate-800 border-slate-200" },
  ];
